...
// Helper to wrap the create/edit logic. 
// Since this is a file content, I'll make it generic for both new and [id].
// This specific file will be for `new`. I'll create `[id]/page.tsx` separately or share a component.
// I'll create a reusable component `CountdownForm` in `src/components/admin/CountdownForm.tsx` (not in plan but better).
// For now, to stick to plan, I will put the form here directly in `new/page.tsx` and copy to `[id]/page.tsx` or handle it smart.

// Let's create `src/components/admin/CountdownForm.tsx` first? 
// No, I'll just write it once in `src/components/admin/CountdownForm.tsx` and use it.
...
function CountdownForm({ defaultValues, id }: { defaultValues?: any, id?: string }) {
...
// I need to export the Form component to reuse it in [id]/page.tsx
